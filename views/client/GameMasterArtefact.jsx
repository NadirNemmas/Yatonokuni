            ...
            <div className="project-item">
              <div className="project-left">
                ...
                <p className="project-description">
                  GameMasterArtefact est un bot Discord conçue pour les maîtres
                  de jeu et les joueurs de jeux de rôle en ligne. Elle permet de
                  gérer les personnages, les feuilles de personnage, et
                  d'exécuter des commandes spécifiques pour faciliter le
                ...
                <p className="project-note">
                  Il est possible d'avoir plus d'informations sur les commandes
                  en cliquant sur la flèche à côté du nom de la commande.
                </p>
              </div>
